...
import { checkParameters, extractErrorMessage, generateFolderPath, generateRepositoryPath, generateTokenType, isNullOrUndefined } from './util.js';
/**
 * Initializes and runs the action.
 */
export default async function run(configuration) {
